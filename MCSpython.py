...
def Gain_mcs(name,Alpha,b=2000):
    Loss=pd.read_csv("/Users/guidongzhang/Desktop/701project/701data/"+name+"_loss.csv")
    Loss=Loss.drop(Loss.columns[[0]], axis = 1)
    mcs = ModelConfidenceSet(Loss,alpha=Alpha,B=b,w=3,algorithm="SQ").run()
    return mcs
def stat(mcs):
    l1,l2,l3=[],[],[]
...
SXP1E=pd.read_csv("/Users/guidongzhang/Desktop/701project/701data/SXP1E_loss.csv")
SXW1E=pd.read_csv("/Users/guidongzhang/Desktop/701project/701data/SXW1E_loss.csv")
SXXP=pd.read_csv("/Users/guidongzhang/Desktop/701project/701data/SXXP_loss.csv")
